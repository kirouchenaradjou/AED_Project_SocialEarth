...
public class NewChatListener extends Thread implements MessageListener {
    ...
    String to = null, tos;
    NewChatListener link = null;

    public NewChatListener(String str) {
        receipient = str;
...
//			send_but.setActionCommand(connection.getRoster().getPresence(receipient).getFrom());
        ...
        chat = GoogleTalkChatLogin.connection.getChatManager().createChat(receipient, this);
    }
