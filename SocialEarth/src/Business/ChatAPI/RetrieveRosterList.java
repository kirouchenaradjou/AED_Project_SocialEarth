...
public class RetrieveRosterList {
	...
	public RetrieveRosterList(String username, String password) throws XMPPException{

		System.out.println("retrieve roster beginning...");
		frame = GoogleTalkChatLogin.frame;
...
//entry is not available, we need to add it to list and make it display....
					...
					System.out.println("some new one has come");
		 	    	...
		 	    	connect.addActionListener(new ActionListener(){
						...
						public void actionPerformed(ActionEvent event) {
							NewChatListener chat_box = new NewChatListener(event.getActionCommand());
							chat_box.start();
						}
		...
		show_list(panel);
		panel_to_frame(panel);
		new ReceiverChatThreadListener();
//		new add_to_list();
//		new receive_file();		
